...
public class DataParser extends Parser {
    ...
    public static class CalcContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(DataParser.EOF, 0);
        }
    ...
    public static class Expr_nameContext extends ParserRuleContext {
        public TerminalNode NAME() {
            return getToken(DataParser.NAME, 0);
        }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public TerminalNode INT() {
            return getToken(DataParser.INT, 0);
        }

        public TerminalNode DOUBLE() {
            return getToken(DataParser.DOUBLE, 0);
        }
